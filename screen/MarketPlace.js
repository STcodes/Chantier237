  ...
  return (
    <Stack.Navigator initialRouteName="OffreHome">
      <Stack.Screen name="MarketPlaceHome" options={{ headerShown: false }}>
        {(props) => (
          <MarketPlaceHome {...props} idUser={route.params.stateUser.userId} />
        )}
      </Stack.Screen>
      ...
      <Stack.Screen name="ListOwnProduct" options={{ headerShown: false }}>
        {(props) => (
          <ListOwnProduct {...props} idUser={route.params.stateUser.userId} />
        )}
      </Stack.Screen>

      <Stack.Screen name="SingleProduct" options={{ headerShown: false }}>
        {(props) => (
          <SingleProduct {...props} idUser={route.params.stateUser.userId} />
        )}
      </Stack.Screen>
    </Stack.Navigator>
  );
